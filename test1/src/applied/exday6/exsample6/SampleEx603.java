...
public class SampleEx603 {
    public static void main(String[] args) {
        ...
        if (s1.equals(s2)) {
            System.out.println("s1とs2の文字列は等しい"); // pass
        } else {
            System.out.println("s1とs2の文字列は等しくない");
        }

        if (s1.equals(s3)) {
            System.out.println("s1とs3の文字列は等しい"); // pass
        } else {
            System.out.println("s1とs3の文字列は等しくない");
        }

        if (s1 == s2) {
            System.out.println("s1とs2のオブジェクトは等しい"); // pass
        } else {
        ...
        if (s1 == s3) {
            ...
            System.out.println("s1とs3のオブジェクトは等しくない"); // pass
        }
    }
}
